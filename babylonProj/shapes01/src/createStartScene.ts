...
function createCapsule(scene: Scene) {
  ...
  var texture2 = new StandardMaterial("reflective", scene);
  texture2.ambientTexture = new Texture("/assets/textures/reflectivity.png", scene);
  texture2.diffuseColor = new Color3(1, 1, 1);
  capsule.material = texture2;
  return capsule;
}
